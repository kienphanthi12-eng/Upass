...
for d in MINERU_DIR.iterdir():
    if d.is_dir() and "tay-ninh" in d.name.lower() and "tieng-anh" in d.name.lower():
        target_folder = d
        break
    elif d.is_dir() and "tay_ninh" in d.name.lower() and "tieng_anh" in d.name.lower():
        target_folder = d
        break
    elif d.is_dir() and "tay" in d.name.lower() and "anh" in d.name.lower():
        target_folder = d
        break
